...
const Work = () => {
  return (
    <div className="h-auto">
      <div className="bg-yellow-200 shadow-md md:max-w-md max-w-sm sm:max-w-lg rounded-md group mt-8 md:mt-0 hover:border-[1px] hover:border-yellow-300 hover:scale-95 transition-all duration-500 ease-in-out">
        <div className="p-5">
