...
const About = () => {
  return (
    <Link href="/about">
      <div className="bg-textDark max-w-sm sm:max-w-lg md:max-w-md overflow-hidden hover:border-4 hover:border-yellow-300 relative aspect-[4/6] group shadow-md rounded-xl ">
        <Image
