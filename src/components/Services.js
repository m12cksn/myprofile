...
const Services = () => {
  ...
  return (
    <div>
      <div className="bg-textDark  shadow-md max-w-sm md:max-w-md sm:max-w-lg rounded-md lg:max-w-2xl mt-8 md:mt-0 xl:mt-0 hover:border-[1px]  group  transition-all duration-500 ease-in-out">
        ...
        <div className="flex px-5 gap-3 xl:h-36 bg-yellow-200 md:h-[10.8rem] py-5 md:py-6">
